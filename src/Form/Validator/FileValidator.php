 ...
 *
 * @property int KB_BYTES
 * @property int MB_BYTES
 * @property int KIB_BYTES
 * @property int MIB_BYTES
 *
 * @property array $suffices
 *
...
class FileValidator extends ConstraintValidator
{
    ...
    {
        if (!$constraint instanceof \App\Form\Validator\File) {
