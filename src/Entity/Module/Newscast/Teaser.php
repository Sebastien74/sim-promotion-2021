...
class Teaser extends BaseTeaser
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity="App\Entity\Module\Newscast\Category", fetch="EXTRA_LAZY")
     * @ORM\JoinTable(name="module_newscast_teasers_categories",
     ...
     * @ORM\JoinTable(name="module_newscast_teaser_i18ns",
     *      joinColumns={@ORM\JoinColumn(name="teaser_id", referencedColumnName="id", onDelete="cascade")},
