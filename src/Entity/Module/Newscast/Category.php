...
class Category extends BaseEntity
{
    ...
    /**
     * @ORM\OneToOne(targetEntity="App\Entity\Layout\Layout", inversedBy="newscastcategory", cascade={"persist", "remove"}, fetch="EXTRA_LAZY")
     * @ORM\JoinColumn(name="layout_id", referencedColumnName="id")
     */
    private $layout;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Module\Newscast\Newscast", mappedBy="category", cascade={"persist"}, fetch="EXTRA_LAZY")
     ...
     * @ORM\JoinTable(name="module_newscast_category_i18ns",
     ...
     * @ORM\JoinTable(name="module_newscast_category_relations",
     *      joinColumns={@ORM\JoinColumn(name="category_id", referencedColumnName="id", onDelete="cascade")},
    ...
    public function getUseDefaultTemplate(): ?bool
    {
        return $this->useDefaultTemplate;
    }

    public function setUseDefaultTemplate(bool $useDefaultTemplate): self
    {
