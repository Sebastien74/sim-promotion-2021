...
use App\Repository\Module\Event\EventRepository;
...
class Event extends BaseEntity
{
    ...
    /**
     * @ORM\OneToOne(targetEntity="App\Entity\Layout\Layout", inversedBy="event", cascade={"persist", "remove"}, fetch="EXTRA_LAZY")
     * @ORM\JoinColumn(name="layout_id", referencedColumnName="id")
     */
    private $layout;

    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\Module\Event\Category", inversedBy="events", cascade={"persist"}, fetch="EXTRA_LAZY")
     ...
     * @ORM\JoinTable(name="module_event_i18ns",
     ...
     * @ORM\OrderBy({"locale"="ASC"})
     * @ORM\JoinTable(name="module_event_urls",
     *      joinColumns={@ORM\JoinColumn(name="event_id", referencedColumnName="id", onDelete="cascade")},
     ...
     * @ORM\JoinTable(name="module_event_media_relations",
     *      joinColumns={@ORM\JoinColumn(name="event_id", referencedColumnName="id", onDelete="cascade")},
