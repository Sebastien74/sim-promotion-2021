...
*/
                    ...
                    LinkDialog_createClass(LinkDialog, [{
                        ...
                        value: function initialize() {
                            ...
                            this.$dialog = this.ui.dialog({
                                ...
                                title: '<img src="/medias/icons/fontawesome/light/link.svg" class="img-fluid">',
                ...
                var ImageDialog_ImageDialog = /*#__PURE__*/function () {
                    ...
                    ImageDialog_createClass(ImageDialog, [{
                        ...
                        value: function initialize() {
                            ...
                            var buttonClass = 'btn btn-info note-btn note-btn-primary note-image-btn';
                            var footer = "<input type=\"button\" href=\"#\" class=\"".concat(buttonClass, "\" value=\"").concat(this.lang.image.insert, "\" disabled>");
                            this.$dialog = this.ui.dialog({
                                title: '<img src="/medias/icons/fontawesome/light/image.svg" class="img-fluid">',
                                fade: this.options.dialogsFade,
                                body: body,
                                footer: footer
                            }).render().appendTo($container);
                ...
                var VideoDialog_VideoDialog = /*#__PURE__*/function () {
                    ...
                    VideoDialog_createClass(VideoDialog, [{
                        ...
                        value: function initialize() {
                            ...
                            var buttonClass = 'btn btn-info note-btn note-btn-primary note-video-btn';
                            var footer = "<input type=\"button\" href=\"#\" class=\"".concat(buttonClass, "\" value=\"").concat(this.lang.video.insert, "\" disabled>");
                            this.$dialog = this.ui.dialog({
                                title: '<img src="/medias/icons/fontawesome/light/video.svg" class="img-fluid">',
                                fade: this.options.dialogsFade,
                                body: body,
                                footer: footer
                            }).render().appendTo($container);
            ...
            /***/ (function (module, __webpack_exports__, __webpack_require__) {
                ...
                var dialog = renderer["a" /* default */].create('<div class="modal note-modal summernote-modal border-modal" aria-hidden="false" tabindex="-1" role="dialog"/>', function ($node, options) {
                    if (options.fade) {
                        $node.addClass('fade');
                    }
                    ...
                    $node.html(['<div class="modal-dialog">', '<div class="modal-content border">', options.title ? '<div class="modal-header">' + '<h4 class="modal-title text-center w-100">' + options.title + '</h4>' + '<button type="button" class="close" data-dismiss="modal" aria-label="Close" aria-hidden="true"><img src="/medias/icons/fontawesome/light/times.svg" class="img-fluid" width="20" height="20"></button>' + '</div>' : '', '<div class="modal-body">' + options.body + '</div>', options.footer ? '<div class="modal-footer">' + options.footer + '</div>' : '', '</div>', '</div>'].join(''));
                });
                ...
                var ui_checkbox = renderer["a" /* default */].create('<div class="form-check"></div>', function ($node, options) {
                    ...
                    $node.html([
                        ...
                        ' <input role="checkbox" type="checkbox" class="custom-control-input"' + (options.id ? ' id="' + options.id + '"' : 'id="input-modal-' + uniqid + '"'),
                        (options.checked ? ' checked' : ''),
                        ' aria-label="' + (options.text ? options.text : '') + '"',
                        ' aria-checked="' + (options.checked ? 'true' : 'false') + '"/>',
                        '<label class="checkbox-custom cursor custom-control-label"' + (options.id ? ' for="' + options.id + '"' : 'for="input-modal-' + uniqid + '"') + '>' + (options.text ? options.text : '') + '</label></div>',
                    ].join(''));
                });
